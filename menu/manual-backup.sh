...
clear
source /etc/carntech/token.json
if [ -f "/etc/carntech/token.json" ]; then
rm -rf /root/backup
mkdir /root/backup
...
echo -e " ${PURPLE}  Script Credit By  carntech STORE${NC}"
echo -e " ${TEAL}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
exit 0
fi
echo -e "${TEAL}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
...
enable_crontab() {
    ...
    if [[ "$enable_crontab" =~ ^[Yy]$ ]]; then
        (crontab -l 2>/dev/null; echo "0 */23 * * * /usr/bin/carntech-manual-backup") | crontab -
