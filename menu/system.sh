...
show_footer() {
    ...
    echo -e " ${COLOR1}║                  ${WH}• carntech STORE •                ${COLOR1}║${NC}"
    echo -e " ${COLOR1}╚════════════════════════════════════════════════════╝${NC}"
}
...
function domain() {
    ...
    install_slowdns() {
        local script_url="https://raw.githubusercontent.com/carntech/genom/refs/heads/main/SLOWDNS/installsl.sh"
...
/root/.acme.sh/acme.sh --register-account -m carntech.cfd
...
10 |10) clear ; wget -q https://github.com/carntech/genom/raw/refs/heads/main/install-ulang-vps && bash install-ulang-vps ;; 
11 |11) clear ; del-exp ;;
00 |0) clear ; menu ;; 
