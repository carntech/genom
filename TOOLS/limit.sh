#!/bin/bash
REPO="https://raw.githubusercontent.com/carntech/genom/refs/heads/main/"
...
cd
wget -q -O /usr/bin/limit-ip "https://github.com/carntech/genom/raw/refs/heads/main/TOOLS/limit-ip"
chmod +x /usr/bin/*
cd /usr/bin
sed -i 's/\r//' limit-ip
cd
